...
var filter_UtilService_Echo_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
...
func RegisterUtilServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UtilServiceServer) error {
	mux.Handle("GET", pattern_UtilService_Echo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/openbank.core.v1.util.UtilService/Echo", runtime.WithHTTPPathPattern("/v1/util/echo"))
		if err != nil {
...
func RegisterUtilServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UtilServiceClient) error {
	mux.Handle("GET", pattern_UtilService_Echo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/openbank.core.v1.util.UtilService/Echo", runtime.WithHTTPPathPattern("/v1/util/echo"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_UtilService_Echo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "util", "echo"}, ""))

	pattern_UtilService_Echo_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "util", "echo"}, ""))
)
